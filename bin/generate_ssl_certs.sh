...
generateCert director 10.0.0.6 # <--- Replace with public Director IP
generateCert uaa-web 10.0.0.6 # <--- Replace with public Director IP
generateCert uaa-sp 10.0.0.6 # <--- Replace with public Director IP
